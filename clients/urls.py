...
urlpatterns = [
    ...
    path('perequations/', views.villes_perequation, name='villes_perequation'),
    ...
    path('rapports/encaissements-commerciaux/', views.rapport_encaissements_commerciaux, name='rapport_encaissements_commerciaux'),
    path('rapports/encaissements-commerciaux/export/xls/', views.export_rapport_encaissements_commerciaux_xls, name='export_rapport_encaissements_commerciaux_xls'),
    path('rapports/encaissements-commerciaux/export/pdf/', views.export_rapport_encaissements_commerciaux_pdf, name='export_rapport_encaissements_commerciaux_pdf'),
    path('rapports/factures-clients/', views.rapport_factures_clients, name='rapport_factures_clients'),
    path('rapports/factures-clients/export/xls/', views.export_rapport_factures_clients_xls, name='export_rapport_factures_clients_xls'),
    path('rapports/factures-clients/export/pdf/', views.export_rapport_factures_clients_pdf, name='export_rapport_factures_clients_pdf'),
