...
def build_user_permissions(user):
    ...
    return {
        ...
        "can_access_commandes": user_has_role(user, ROLE_COMMERCIAL, ROLE_COMPTABLE, ROLE_DIRECTEUR, ROLE_LOGISTIQUE),
        "can_add_commandes": user_has_role(user, ROLE_COMMERCIAL),
        "can_edit_commandes": is_boss or user_has_role(user, ROLE_COMMERCIAL),
