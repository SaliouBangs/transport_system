...
urlpatterns = [
    ...
    path("stock/mouvement/<int:article_id>/", views.ajouter_mouvement_stock, name="ajouter_mouvement_stock"),
    path("rapports/", views.rapport_maintenances, name="rapport_maintenances"),
    path("rapports/export/xls/", views.export_rapport_maintenances_xls, name="export_rapport_maintenances_xls"),
